...
// Check if the order date is after today's date
$orderDate = $booking['date'];
$allowCancellation = ($orderDate > $today);
?>
...
<?php include_once("../base/nav_user.php"); ?>
    <div class="container mx-auto mt-4">
        ...
        <div class="card border border-gray-300 shadow-lg rounded-lg mx-auto" id="printableArea">
            ...
            <!-- QR Code Section -->
            <div class="card-footer text-center" style="padding: 25px;">
                <div class="row">
                    <div class="col-sm-6">
        ...
        <?php if ($allowCancellation): ?>
            <form action="booking_cancel.php" method="post" class="d-inline">
                <input type="hidden" name="booking_id" value="<?php echo $bookingId; ?>">
                <button type="submit" class="btn btn-danger mx-2">Cancel Booking</button>
            </form>
        <?php endif; ?>
    </div>
